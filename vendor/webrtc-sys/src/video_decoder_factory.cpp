...
#ifdef WEBRTC_ANDROID
  // VISIO: Disable Android hardware video decoder — the MediaCodec decoder
  // thrashes between simulcast layers (320x180 <-> 1280x720), releasing the
  // codec before OnFrame() can deliver decoded frames to NativeVideoStream.
  // Software decoder (libvpx/VP9Decoder) works correctly.
